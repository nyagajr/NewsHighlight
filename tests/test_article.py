...
class TestArticles(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_article = Article('BBC','Independent','Nyaga jr','APIs','Pulling articles through','https://google.com','https://google.com/images','2019-02-02T12:00:00Z','content')
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEquals(self.new_article.author,'Nyaga jr')
